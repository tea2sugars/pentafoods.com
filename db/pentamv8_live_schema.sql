...
--
-- Host: localhost
-- Generation Time: Oct 17, 2013 at 11:50 AM
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Stores block settings, such as region and visibility...' AUTO_INCREMENT=229 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Stores contents of custom-made blocks.' AUTO_INCREMENT=25 ;
...
CREATE TABLE IF NOT EXISTS `faq_weights` (
  ...
  PRIMARY KEY (`nid`,`tid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='A table containing the weight of each faq node by category.';
...
--
-- Table structure for table `field_data_field_larger`
--

CREATE TABLE IF NOT EXISTS `field_data_field_larger` (
  `entity_type` varchar(128) NOT NULL DEFAULT '' COMMENT 'The entity type this data is attached to',
  `bundle` varchar(128) NOT NULL DEFAULT '' COMMENT 'The field instance bundle to which this row belongs, used when deleting a field instance',
  `deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'A boolean indicating whether this data item has been deleted',
  `entity_id` int(10) unsigned NOT NULL COMMENT 'The entity id this data is attached to',
  ...
  `language` varchar(32) NOT NULL DEFAULT '' COMMENT 'The language for this data item.',
  `delta` int(10) unsigned NOT NULL COMMENT 'The sequence number for this data item, used for multi-value fields',
  `field_larger_fid` int(10) unsigned DEFAULT NULL COMMENT 'The file_managed.fid being referenced in this field.',
  `field_larger_alt` varchar(512) DEFAULT NULL COMMENT 'Alternative image text, for the image’s ’alt’ attribute.',
  `field_larger_title` varchar(1024) DEFAULT NULL COMMENT 'Image title text, for the image’s ’title’ attribute.',
  `field_larger_width` int(10) unsigned DEFAULT NULL COMMENT 'The width of the image in pixels.',
  `field_larger_height` int(10) unsigned DEFAULT NULL COMMENT 'The height of the image in pixels.',
  PRIMARY KEY (`entity_type`,`entity_id`,`deleted`,`delta`,`language`),
  KEY `entity_type` (`entity_type`),
  KEY `bundle` (`bundle`),
  KEY `deleted` (`deleted`),
  ...
  KEY `revision_id` (`revision_id`),
  KEY `language` (`language`),
  KEY `field_larger_fid` (`field_larger_fid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Data storage for field 11 (field_larger)';

-- --------------------------------------------------------

--
-- Table structure for table `field_data_field_penta_brands`
--

CREATE TABLE IF NOT EXISTS `field_data_field_penta_brands` (
  `entity_type` varchar(128) NOT NULL DEFAULT '' COMMENT 'The entity type this data is attached to',
  `bundle` varchar(128) NOT NULL DEFAULT '' COMMENT 'The field instance bundle to which this row belongs, used when deleting a field instance',
  `deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'A boolean indicating whether this data item has been deleted',
  `entity_id` int(10) unsigned NOT NULL COMMENT 'The entity id this data is attached to',
  ...
  `language` varchar(32) NOT NULL DEFAULT '' COMMENT 'The language for this data item.',
  `delta` int(10) unsigned NOT NULL COMMENT 'The sequence number for this data item, used for multi-value fields',
  `field_penta_brands_tid` int(10) unsigned DEFAULT NULL,
  PRIMARY KEY (`entity_type`,`entity_id`,`deleted`,`delta`,`language`),
  KEY `entity_type` (`entity_type`),
  KEY `bundle` (`bundle`),
  KEY `deleted` (`deleted`),
  ...
  KEY `revision_id` (`revision_id`),
  KEY `language` (`language`),
  KEY `field_penta_brands_tid` (`field_penta_brands_tid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Data storage for field 9 (field_penta_brands)';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Data storage for field 5 (field_product_image)';

-- --------------------------------------------------------

--
-- Table structure for table `field_data_field_rightimage`
--

CREATE TABLE IF NOT EXISTS `field_data_field_rightimage` (
  `entity_type` varchar(128) NOT NULL DEFAULT '' COMMENT 'The entity type this data is attached to',
  `bundle` varchar(128) NOT NULL DEFAULT '' COMMENT 'The field instance bundle to which this row belongs, used when deleting a field instance',
  `deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'A boolean indicating whether this data item has been deleted',
  `entity_id` int(10) unsigned NOT NULL COMMENT 'The entity id this data is attached to',
  ...
  `language` varchar(32) NOT NULL DEFAULT '' COMMENT 'The language for this data item.',
  `delta` int(10) unsigned NOT NULL COMMENT 'The sequence number for this data item, used for multi-value fields',
  `field_rightimage_fid` int(10) unsigned DEFAULT NULL COMMENT 'The file_managed.fid being referenced in this field.',
  `field_rightimage_alt` varchar(512) DEFAULT NULL COMMENT 'Alternative image text, for the image’s ’alt’ attribute.',
  `field_rightimage_title` varchar(1024) DEFAULT NULL COMMENT 'Image title text, for the image’s ’title’ attribute.',
  `field_rightimage_width` int(10) unsigned DEFAULT NULL COMMENT 'The width of the image in pixels.',
  `field_rightimage_height` int(10) unsigned DEFAULT NULL COMMENT 'The height of the image in pixels.',
  PRIMARY KEY (`entity_type`,`entity_id`,`deleted`,`delta`,`language`),
  KEY `entity_type` (`entity_type`),
  KEY `bundle` (`bundle`),
  KEY `deleted` (`deleted`),
  ...
  KEY `revision_id` (`revision_id`),
  KEY `language` (`language`),
  KEY `field_rightimage_fid` (`field_rightimage_fid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Data storage for field 10 (field_rightimage)';

-- --------------------------------------------------------

--
-- Table structure for table `field_data_field_sub_category`
--

CREATE TABLE IF NOT EXISTS `field_data_field_sub_category` (
  `entity_type` varchar(128) NOT NULL DEFAULT '' COMMENT 'The entity type this data is attached to',
  `bundle` varchar(128) NOT NULL DEFAULT '' COMMENT 'The field instance bundle to which this row belongs, used when deleting a field instance',
  `deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'A boolean indicating whether this data item has been deleted',
  `entity_id` int(10) unsigned NOT NULL COMMENT 'The entity id this data is attached to',
  ...
  `language` varchar(32) NOT NULL DEFAULT '' COMMENT 'The language for this data item.',
  `delta` int(10) unsigned NOT NULL COMMENT 'The sequence number for this data item, used for multi-value fields',
  `field_sub_category_value` varchar(255) DEFAULT NULL,
  `field_sub_category_format` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`entity_type`,`entity_id`,`deleted`,`delta`,`language`),
  KEY `entity_type` (`entity_type`),
  KEY `bundle` (`bundle`),
  KEY `deleted` (`deleted`),
  ...
  KEY `revision_id` (`revision_id`),
  KEY `language` (`language`),
  KEY `field_sub_category_format` (`field_sub_category_format`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Data storage for field 6 (field_sub_category)';
...
--
-- Table structure for table `field_revision_field_larger`
--

CREATE TABLE IF NOT EXISTS `field_revision_field_larger` (
  `entity_type` varchar(128) NOT NULL DEFAULT '' COMMENT 'The entity type this data is attached to',
  `bundle` varchar(128) NOT NULL DEFAULT '' COMMENT 'The field instance bundle to which this row belongs, used when deleting a field instance',
  `deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'A boolean indicating whether this data item has been deleted',
  `entity_id` int(10) unsigned NOT NULL COMMENT 'The entity id this data is attached to',
  ...
  KEY `language` (`language`),
  KEY `field_larger_fid` (`field_larger_fid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Revision archive storage for field 11 (field_larger)';

-- --------------------------------------------------------

--
-- Table structure for table `field_revision_field_penta_brands`
--

CREATE TABLE IF NOT EXISTS `field_revision_field_penta_brands` (
  `entity_type` varchar(128) NOT NULL DEFAULT '' COMMENT 'The entity type this data is attached to',
  `bundle` varchar(128) NOT NULL DEFAULT '' COMMENT 'The field instance bundle to which this row belongs, used when deleting a field instance',
  `deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'A boolean indicating whether this data item has been deleted',
  `entity_id` int(10) unsigned NOT NULL COMMENT 'The entity id this data is attached to',
  ...
  KEY `language` (`language`),
  KEY `field_penta_brands_tid` (`field_penta_brands_tid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Revision archive storage for field 9 (field_penta_brands)';
...
CREATE TABLE IF NOT EXISTS `field_revision_field_product_image` (
  ...
  KEY `language` (`language`),
  KEY `field_product_image_fid` (`field_product_image_fid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Revision archive storage for field 5 (field_product_image)';

-- --------------------------------------------------------

--
-- Table structure for table `field_revision_field_rightimage`
--

CREATE TABLE IF NOT EXISTS `field_revision_field_rightimage` (
  `entity_type` varchar(128) NOT NULL DEFAULT '' COMMENT 'The entity type this data is attached to',
  `bundle` varchar(128) NOT NULL DEFAULT '' COMMENT 'The field instance bundle to which this row belongs, used when deleting a field instance',
  `deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'A boolean indicating whether this data item has been deleted',
  `entity_id` int(10) unsigned NOT NULL COMMENT 'The entity id this data is attached to',
  ...
  KEY `language` (`language`),
  KEY `field_rightimage_fid` (`field_rightimage_fid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Revision archive storage for field 10 (field_rightimage)';

-- --------------------------------------------------------

--
-- Table structure for table `field_revision_field_sub_category`
--

CREATE TABLE IF NOT EXISTS `field_revision_field_sub_category` (
  `entity_type` varchar(128) NOT NULL DEFAULT '' COMMENT 'The entity type this data is attached to',
  `bundle` varchar(128) NOT NULL DEFAULT '' COMMENT 'The field instance bundle to which this row belongs, used when deleting a field instance',
  `deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'A boolean indicating whether this data item has been deleted',
  `entity_id` int(10) unsigned NOT NULL COMMENT 'The entity id this data is attached to',
  ...
  KEY `language` (`language`),
  KEY `field_sub_category_format` (`field_sub_category_format`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Revision archive storage for field 6 (field_sub_category)';
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Stores information for uploaded files.' AUTO_INCREMENT=225 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Flood controls the threshold of events, such as the...' AUTO_INCREMENT=13 ;
...
CREATE TABLE IF NOT EXISTS `image_effects` (
  ...
  KEY `isid` (`isid`),
  KEY `weight` (`weight`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Stores configuration options for image effects.' AUTO_INCREMENT=17 ;
...
CREATE TABLE IF NOT EXISTS `image_styles` (
  ...
  PRIMARY KEY (`isid`),
  UNIQUE KEY `name` (`name`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Stores configuration options for image styles.' AUTO_INCREMENT=9 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Contains the individual links within a menu.' AUTO_INCREMENT=843 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='The base table for nodes.' AUTO_INCREMENT=104 ;
...
CREATE TABLE IF NOT EXISTS `node_revision` (
  ...
  KEY `nid` (`nid`),
  KEY `uid` (`uid`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Stores information about each saved version of a node.' AUTO_INCREMENT=104 ;
...
CREATE TABLE IF NOT EXISTS `queue` (
  ...
  KEY `expire` (`expire`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Stores items in queues.' AUTO_INCREMENT=1058 ;
...
--
-- Table structure for table `resp_img_suffix`
--

CREATE TABLE IF NOT EXISTS `resp_img_suffix` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'The internal identifier for a responsive images suffix',
  `name` varchar(255) NOT NULL COMMENT 'The name of the suffix.',
  `label` varchar(255) NOT NULL DEFAULT '' COMMENT 'The label of the suffix.',
  `suffix` varchar(255) NOT NULL DEFAULT '' COMMENT 'The suffix.',
  `breakpoint` int(11) NOT NULL DEFAULT '0' COMMENT 'The breakpoint in pixels for this suffix',
  PRIMARY KEY (`id`),
  UNIQUE KEY `name` (`name`),
  KEY `suffix` (`suffix`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Defines responsive images suffix’' AUTO_INCREMENT=5 ;
...
CREATE TABLE IF NOT EXISTS `sequences` (
  ...
  PRIMARY KEY (`value`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Stores IDs.' AUTO_INCREMENT=155 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='A list of URL aliases for Drupal paths; a user may visit...' AUTO_INCREMENT=252 ;
...
CREATE TABLE IF NOT EXISTS `views_view` (
  ...
  PRIMARY KEY (`vid`),
  UNIQUE KEY `name` (`name`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Stores the general data for a view.' AUTO_INCREMENT=6 ;
...
CREATE TABLE IF NOT EXISTS `watchdog` (
  ...
  KEY `type` (`type`),
  KEY `uid` (`uid`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Table that contains logs of all system events.' AUTO_INCREMENT=49271 ;
...
CREATE TABLE IF NOT EXISTS `webform_submissions` (
  ...
  KEY `nid_sid` (`nid`,`sid`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Holds general information about submissions outside of...' AUTO_INCREMENT=162 ;
